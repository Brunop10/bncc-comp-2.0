    ...
    <div className="fixed inset-0 z-[9998] pointer-events-none" id="app-evaluation-hud">
      ...
      <div className="pointer-events-auto fixed bottom-4 right-4 flex flex-col items-end gap-2">
        <button
          ...
          title={hudMinimized ? 'Expandir controles' : 'Minimizar controles'}
          className={`rounded-full shadow-lg border focus:outline-none focus:ring-2 p-2 ${hudMinimized ? 'bg-purple-600 text-white border-purple-700 hover:bg-purple-700 focus:ring-purple-500' : 'bg-white text-gray-600 border-gray-300 hover:bg-gray-100 focus:ring-purple-500'}`}
        >
                      ...
                      <div key={t.id} className="rounded-lg border bg-white/90 p-2">
                        <div className="flex items-start gap-2">
                          ...
                          <div className="flex-1">
                            <p className="text-[13px] leading-snug">{i + 1}. {t.toastTitle}</p>
